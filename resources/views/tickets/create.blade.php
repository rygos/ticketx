                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/tickets/store') }}">
                            ...
                            <div class="form-group{{ $errors->has('serial') ? ' has-error' : '' }}">
                                <label for="title" class="col-md-4 control-label">Serial</label>

                                <div class="col-md-6">
                                    <input id="title" type="text" class="form-control" name="serial" placeholder="Type in a serial number" value="{{ old('serial') }}">
